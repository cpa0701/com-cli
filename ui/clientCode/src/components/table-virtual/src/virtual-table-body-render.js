        ...
        >
          <colgroup>
            {this._l(this.columns, (column, cellIndex) =>
              columnsHidden[cellIndex] && this.fixed ? (
                ''
              ) : (
                <col name={column.id} />
              )
          ...
          <tbody>
            {this._l(rows, (row, index) => {
              ...
              const rowKey = this.table.useRowKey
                ? this.table.rowKey
                  ...
                  {this._l(this.columns, (column, cellIndex) => {
                    ...
                    if (
                      ...
                      return (
                        ...
                        >
                          {this.isRenderCell(column, cellIndex) &&
